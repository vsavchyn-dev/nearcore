...
impl ArchivalDataLossRecoveryCommand {
    pub fn run(
        ...
        let shard_layout =
            epoch_manager.static_shard_layout_for_protocol_version(self.protocol_version);
        let prev_shard_layout =
            epoch_manager.static_shard_layout_for_protocol_version(self.protocol_version - 1);
        assert_ne!(
